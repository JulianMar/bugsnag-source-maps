...
function uploadBrowser(argv, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let browserOpts;
        try {
            browserOpts = (0, command_line_args_1.default)(defs, { argv, camelCase: true });
            if (opts.help)
                return browserUsage();
...
function validateBrowserOpts(opts) {
    ...
    if (opts.codeBundleId) {
        ...
        if (opts.detectAppVersion)
            throw new Error('--detect-app-version and --code-bundle-id cannot both be given');
    }
